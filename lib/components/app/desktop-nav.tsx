...
import { accountLinks, getAuth0Config, isFirebaseEnabled } from '../../util/auth'
...
import NavLoginButtonFirebase from '../user/nav-login-button-firebase'
...
const DesktopNav = ({
  ...
  const intl = useIntl()
  const showLogin = Boolean(getAuth0Config(persistence) || isFirebaseEnabled(persistence))
...
const mapStateToProps = (state: AppReduxState) => {
  ...
  return {
    ...
    useFirebase: isFirebaseEnabled(otpConfig.persistence)
  }
}
